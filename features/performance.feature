...
Scenario: Private Register with Title Extents
  ...
  And the scenarios response times were below:
    ...
    | Create relationship token for buyers                                   | 12      |
    | Processing Absolute Freehold First Registration with 1 proprietor (3)  | 12      |
    | Citizen authorises the conveyancer client relationship                 | 12      |
    | View Change of Name in work queue                                      | 20      |
